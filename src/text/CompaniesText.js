...
export default {
  ...
  studier: 'Studier',
  data:
    'Dataingeniør-studiet kombinerer det beste fra de spesialiserte informatikkutdanningene og de tradisjonelle ingeniørutdanningene.\n' +
  ...
  IKT:
    'Digital samhandling er et veletablert forskningsområde som tar for seg hvordan utøvelse og koordinering av samarbeidsaktiviteter kan støttes ved hjelp av ulike IKT-systemer. Studentene ved denne 2 årige masteren er i stand til å samhandle effektivt i forskjellige tverrfaglige problemløsningsprosesser.',
  support:
  ...
  jobbannonser: `Vi tilbyr promotering av stillingsannonser ut til våre 600 dyktige studenter på vår karriereside <a href="${URLS.jobposts}">tihlde.org/karriere</a>.`,
  kurs:
