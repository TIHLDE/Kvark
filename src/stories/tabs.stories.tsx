  ...
  render: (args) => (
    <Tabs {...args} className='w-[400px]'>
      ...
      <TabsContent value='account'>
        <p className='text-sm text-slate-500 dark:text-slate-400'>Endre profilen din her. Trykk lagre når du er ferdig.</p>
      ...
      <TabsContent value='password'>
        <p className='text-sm text-slate-500 dark:text-slate-400'>Endre passordet ditt her</p>
        <div className='grid gap-2 py-4'>
          <div className='space-y-1'>
