...
import { cn, useRenderAsChild, useRenderAsChildProp, useRenderParam } from "~/lib/utils"
...
export interface SidebarGroupActionProps extends useRender.ComponentProps<'button'> {
  asChild?: boolean
}
...
export type SidebarMenuSubButtonProps = useRenderAsChildProp<"a"> & {
  size?: "sm" | "md";
  isActive?: boolean;
};
