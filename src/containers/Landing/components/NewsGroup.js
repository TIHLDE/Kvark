...
const styles = theme => ({
    ...
    fade: {
        ...
        height: 20,
        background: '-webkit-linear-gradient(transparent, white), -moz-linear-gradient(transparent, white), -0-linear-gradient(transparent, white), -ms-linear-gradient(transparent, white)',
    },
    image: {
        height: 300,
        width: '100%',
