...
const Companies = () => {
  ...
  const text = {
    aboutUs:
      'TIHLDE (Trondheim IngeniørHøgskoles Linjeforening for Dannede EDBere) er linjeforeningen for bachelorstudiene Dataingeniør, Digital infrastruktur og cybersikkerhet, Digital forretningsutvikling, Informasjonsbehandling, samt masterstudiet Digital transformasjon ved AIT, IDI, NTNU på Gløshaugen.',
