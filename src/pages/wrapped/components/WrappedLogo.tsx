...
const WrappedLogo = () => {
  return (
    <Svg height='70' id='svg2' version='1.1' viewBox={'250 435 2000 450'} width={200} xmlns='http://www.w3.org/2000/svg'>
      <defs id='defs6'>
        <clipPath clipPathUnits='userSpaceOnUse' id='clipPath18'>
          <path d='M 0,1005 H 1920 V 0 H 0 Z' id='path16' />
        </clipPath>
      </defs>
      <text fill='#fff' fontSize='10em' textAnchor='end' x={2250} y={1000}>
        WRAPPED
      </text>
