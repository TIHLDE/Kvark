import { ArrowRight, AtSign, Award, Calendar, CircleHelp, FacebookIcon, HandHeart, Info, InstagramIcon, List, Users2 } from 'lucide-react';
...
const NewStudent = () => {
  ...
  const { data: toddelsData, isFetching, hasNextPage, fetchNextPage } = useToddels();
  ...
  return (
    <Page className=''>
      <div className='h-[70vh] relative z-0 flex justify-center items-center flex-col text-center'>
        <div className='h-96 w-24 rotate-45 bg-cyan-400/40 blur-3xl absolute -bottom-24 left-1 z-0'></div>
        <div className='h-96 w-96  bg-cyan-400/10 blur-3xl absolute -bottom-64 right-0 z-0'></div>
        <div className='h-96 w-96  bg-cyan-400/30 blur-3xl absolute -top-[450px] right-48 z-0'></div>
        <div className='h-96 w-96 bg-cyan-400/30 blur-3xl absolute -bottom-[250px] left-1/2'></div>
        ...
        <div className='flex flex-col md:flex-row gap-2'>
          <a className='https://forms.gle/DdL3F7XHvCHFVzdi8'>
      ...
      <div className='bg-slate-950/30 border items-center py-24 px-16 rounded-3xl z-10 relative grid grid-cols-1 md:grid-cols-2 gap-12'>
        <div>
          ...
          <div className='flex gap-2 flex-col md:flex-row'>
            <a href='https://forms.gle/DdL3F7XHvCHFVzdi8'>
              <Button className='mt-4 mr-2 bg-sky-500 text-white font-semibold' onClick={fadderukaSignupAnalytics}>
                Meld meg på!
              </Button>
            </a>
            <a href='/fadderuka'>
      ...
      <div className='py-44'>
        ...
        {toddels && toddels[0] && (
          <a className='max-w-5xl w-full mx-auto' href={'/toddel'}>
            <img alt={toddels[0].title} className='rounded-3xl max-w-5xl w-full mx-auto' src={toddels[0].image} />
          </a>
        )}
      </div>
      <div>
