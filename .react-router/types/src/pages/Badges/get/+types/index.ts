...
export type Info = {
  ...
  id: "pages/Badges/get/index"
  file: "./pages/Badges/get/index.tsx"
  path: "badges/erverv/:badgeId?"
  params: {"badgeId"?: string} & { [key: string]: string | undefined }
  module: Module
